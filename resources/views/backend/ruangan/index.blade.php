    ...
    <div class="card card-clean">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table align-middle w-100" id="dataRuangan">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Ruangan</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if ($item->denah)
                                    <img src="{{ asset('storage/' . $item->denah) }}"
                                        class="img-thumb"
                            ...
                            <td>
                                <form action="{{ route('backend.ruangan.updateStatus', $item->id) }}" method="POST">
                                    @csrf
                                    @method('PATCH')
                                    ...
                                    <select name="status"
                                        ...
                                        <option value="dipakai" {{ $item->status == 'dipakai' ? 'selected' : '' }}>
                                            🔴 Dipakai
                                        </option>
                                    </select>
                                </form>
